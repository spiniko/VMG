...
## WEB Validation Message Example:  
...
## How to Use the Favlet
  
### Precondition: 
- Add the VMG script (favlet) in your browser bookmarks bar.
- Ensure you are on the Finding Detail page in the platform.
___
...
- **Step 2:** Activate the favlet script from your browser bookmarks.  
...
- **Step 6:** Upload the corresponding screenshot, ensuring that the _**filename**_ matches the _**autogenerated name**_ provided in the validation message.
  
___
## TODOs  
***Current Limitation***: The tool is currently designed to work exclusively for WEB validations.  
